...
sleep 2
echo "Nama gw DarkSkull :v Orang terganss... di masanya"|lolcat
sleep 1
echo ""
...
echo $yellow "+===========(Darkskull)===========+"
echo $green "|+TOOLS  : LINUX               |"
echo $green  "|+CODING : DarkSkull           |"
echo $yellow "|+CONTAC : 087888336682.       |"
echo $yellow "|+THANKS TO : [•]ABCI[•]       |"
echo $yellow "|+Instagram : mr.darkskull.    |"
echo $yellow "|+Kumpulan terminal pc no root |"
echo $yellow "|~Special Thanks to MR.DIFERS  |"
echo $yellow "+==========[ABCI]===========+"
echo $blue ">>=========={MENU}==========<<"
