...
echo
echo  " ===========================================" | lolcat
echo  " Root Author     : Mr-hillah" | lolcat
...
echo $i"|"$me"15"$i" |"$pu" (install bahan bahanny agar tidak terjadi eror)"
echo $i"|"$me"16"$i" |"$pu" IoT-Implant-Toolkit"
echo $i"|"$me"17"$i" |"$pu" brutespray"
echo $i"|"$me"18"$i" |"$pu" brutality"
echo $i"|"$me"19"$i" |"$pu" discover-A"
echo $i"|"$me"20"$i" |"$pu" OWASP-ZSC"
echo $i"|"$me"21"$i" |"$pu" bluekeep"
echo $i"|"$me"22"$i" |"$pu" WeebSec"
...
figlet -f slant "W A I T"|lolcat
sleep 1
pkg instaall update && pkg install upgrade
pkg install php
pkg install git
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/ManhNho/brutality
cd brutality
pip2 install -r requirements.txt
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/WeebSec/weebdns
cd weebdns
pip3 install -r requirements.txt
python3 weebdns.py
fi
